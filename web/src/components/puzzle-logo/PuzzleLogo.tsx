  ...
  return (
    ...
    >
      ...
      <div className="puzzle-wrapper">
        ...
        <div
          className={`puzzle-piece piece-1 ${visible ? "animate" : ""} ${idle ? "idle" : ""}`}
        >
        ...
        <div
          className={`puzzle-piece piece-2 ${visible ? "animate" : ""} ${idle ? "idle" : ""}`}
        >
          <svg viewBox="0 0 120 120" className="piece-svg">
        ...
        <div
          className={`puzzle-piece piece-3 ${visible ? "animate" : ""} ${idle ? "idle" : ""}`}
        >
          <svg viewBox="0 0 120 120" className="piece-svg">
        ...
        <div
          className={`puzzle-piece piece-4 ${visible ? "animate" : ""} ${idle ? "idle" : ""}`}
        >
          <svg viewBox="0 0 120 120" className="piece-svg">
