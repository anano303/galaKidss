...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "GalaKids -  ტანსაცმლის, ფეხსაცმლისა და აქსესუარების ონლაინ მაღაზია | Clothing, Shoes & Accessories Online Store",
    template: "%s | GalaKids",
  },
  description:
    "GalaKids - თანამედროვე საბავშვო ტანსაცმლის, ფეხსაცმლისა და აქსესუარების ონლაინ მაღაზია საქართველოში. მაღალი ხარისხის პროდუქტები და სწრაფი მიწოდება მთელ ქვეყანაში. | Modern online store for clothing, shoes and accessories in Georgia. High-quality products and fast delivery nationwide.",
  keywords: [
    " ტანსაცმელი",
    " ფეხსაცმელი",
    " აქსესუარები",
  ...
  openGraph: {
    ...
    siteName: "GalaKids",
    title:
      "GalaKids - ა ტანსაცმლის, ფეხსაცმლისა და აქსესუარების ონლაინ მაღაზია | Clothing, Shoes & Accessories Online Store",
    description:
