...
export const metadata: Metadata = {
  title: "მთავარი გვერდი - GalaKids | საბავშვო ონლაინ მაღაზია",
  description:
    "GalaKids - თანამედროვე საბავშვო ტანსაცმლის, ფეხსაცმლისა და აქსესუარების ონლაინ მაღაზია საქართველოში. მოიძიეთ ახალი კოლექციები და ტრენდული პროდუქტები.",
  openGraph: {
    title: "მთავარი გვერდი - GalaKids | საბავშვო ონლაინ მაღაზია",
    description:
      "GalaKids - თანამედროვე საბავშვო ტანსაცმლის, ფეხსაცმლისა და აქსესუარების ონლაინ მაღაზია საქართველოში. მოიძიეთ ახალი კოლექციები და ტრენდული პროდუქტები.",
