...
export default function AboutPage() {
  ...
  const title =
    ...
    (isEn ? "About Us" : "ჩვენ შესახებ - ანუ რატომ შეიქმნა GalaKids");
  ...
  const brandIntroText =
    ...
    (isEn
      ? "A brand created with love, joy and a bit of magic."
  ...
  const ctaText =
    ...
    (isEn
      ? "Join us and wear GalaKids too!"
      : "შემოგვიერთდი და ჩაიცვი GalaKids შენც!");
  const ctaHighlight =
              ...
              <div className={sectionClass} key={idx}>
                <p>
                  ...
                  {section.type === "final" && (
                    <strong>
                      {" "}
                      {sectionText.includes("ეს ყველაფერი") ? "" : ""}
                    </strong>
                  )}
                </p>
                {isAdmin && (
