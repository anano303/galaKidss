      ...
      <div className="tc-edit-wrap">
        ...
        <div className="tc-edit-actions">
          ...
          <button
            ...
            className="tc-edit-btn tc-cancel"
            title="გაუქმება"
          >
            <X size={16} />
          </button>
...
export default function TermsConditions() {
  ...
  const effectiveDateEn = terms?.effectiveDateEn || "June 1, 2025";
  ...
  return (
    <div className="terms-conditions-container">
      <div className="terms-conditions-content">
          ...
          return (
            <div className="terms-section" key={idx}>
              <div className="tc-section-header">
                <h2>{title}</h2>
                {isAdmin && (
                  <div className="tc-section-admin">
                    <EditableText
                      value={title}
                      onSave={(val) =>
        ...
        {isAdmin && (
          <button className="tc-add-section-btn" onClick={handleAddSection}>
